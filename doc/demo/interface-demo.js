 ...
 */
    ...
    var readingSystem = new ReadingSystem(config);
    ...
    readingSystem.initRenderer(container);
    ...
    readingSystem.openEPUB("MobyDick.epub");

    // check and see if any errors occurred
    var errorList = readingSystem.getErrorRoot();
    ...
    readingSystem.nextScreen();

    // jump to the end of the document
    readinSystem.endDocument();
